...
function App() {
  ...
  const listFiles = (searchTerm = null) => {
    gapi.client.drive.files
      .list({
        fields:
          "nextPageToken, files(id, name, parents, mimeType, modifiedTime,thumbnailLink,iconLink,hasThumbnail,webContentLink,webViewLink)",
        q: "'root' in parents",
      })
    ...
    <div className="App">
      ...
      {isLoggedIn ? (
        <div className="flex gap-5 mb-5">
          <Button variant="contained" onClick={() => createFile("New File")}>
            Create File
          </Button>
